...
public class serverTEST {
	...
	public void RunTest1() {
		test00 = new Server(9090, "TEST", "", false, false, false);
		test00.openServer();
	}
	...
	public void RunTest2() {
		test11 = new Server(9091, "TEST1", "Mega", true, true, false);
		test11.openServer();
	}
	@Test
	...
	public void RunTest3() {
		test11 = new Server(9092, "TEST1", "HugeHugePassword of doom12", true, true, false);
